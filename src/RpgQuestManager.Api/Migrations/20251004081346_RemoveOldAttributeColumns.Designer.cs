...
namespace RpgQuestManager.Api.Migrations
{
    ...
    [Migration("20251004081346_RemoveOldAttributeColumns")]
    partial class RemoveOldAttributeColumns
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RpgQuestManager.Api.Models.CombatReward", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("CombatRewardsId")
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("ExperienceAmount")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("CombatRewardsId");

                    b.ToTable("CombatRewardItems");
                });

            modelBuilder.Entity("RpgQuestManager.Api.Models.CombatRewards", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("RpgQuestManager.Api.Models.DiceInventory", b =>
                {
                    ...
                    b.HasIndex("HeroId", "DiceType")
                        .IsUnique();

                    b.ToTable("DiceInventories");
                });

            modelBuilder.Entity("RpgQuestManager.Api.Models.DiceShopItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("RpgQuestManager.Api.Models.HeroEquipment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("RpgQuestManager.Api.Models.QuestReward", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("QuestRewardsId");

                    b.ToTable("QuestRewardItems");
                });

            modelBuilder.Entity("RpgQuestManager.Api.Models.QuestRewards", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("RpgQuestManager.Api.Models.Character", b =>
                {
                    b.HasOne("RpgQuestManager.Api.Models.HeroEquipment", "Equipment")
                        .WithMany()
            ...
            modelBuilder.Entity("RpgQuestManager.Api.Models.CombatReward", b =>
                {
                    b.HasOne("RpgQuestManager.Api.Models.CombatRewards", null)
                        .WithMany("Rewards")
                        .HasForeignKey("CombatRewardsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("RpgQuestManager.Api.Models.CombatRewards", b =>
                {
                    ...
                    b.HasOne("RpgQuestManager.Api.Models.Monster", "Monster")
                        .WithMany()
            ...
            modelBuilder.Entity("RpgQuestManager.Api.Models.HeroEquipment", b =>
                {
                    ...
                    b.HasOne("RpgQuestManager.Api.Models.Hero", "Hero")
                        .WithOne("Equipment")
                        .HasForeignKey("RpgQuestManager.Api.Models.HeroEquipment", "HeroId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("RpgQuestManager.Api.Models.InventoryItem", b =>
                {
                    b.HasOne("RpgQuestManager.Api.Models.Character", null)
                        .WithMany("Inventory")
                        .HasForeignKey("CharacterId");
            ...
            modelBuilder.Entity("RpgQuestManager.Api.Models.QuestReward", b =>
                {
                    b.HasOne("RpgQuestManager.Api.Models.QuestRewards", null)
                        .WithMany("Rewards")
                        .HasForeignKey("QuestRewardsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
